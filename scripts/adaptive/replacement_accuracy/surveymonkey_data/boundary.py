...
#Save results:
o = open('../../../../corpora/adaptive/replacement_accuracy/surveymonkey/boundary_'+name+'_'+mode+'_'+str(sys.argv[1])+'_'+str(ntrains)+'_'+str(step)+'.txt', 'w')
