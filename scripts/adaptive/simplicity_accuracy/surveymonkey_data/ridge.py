...
datapath = '../../../corpora/datasets/SurveyMonkey_Data_With_IDS.txt' #Path to the dataset
...
#Save results:
o = open('../../../corpora/adaptive/surveymonkey/ridge_'+name+'_'+mode+'_'+str(trainprop)+'_'+str(ntrains)+'_'+str(step)+'.txt', 'w')
